...
<html>
    ...
    <div class="layui-header layui-bg-cyan">
        <div class="layui-logo layui-bg-green"><a href="${path}/backstage/cityPage/city_index.jsp">市疾控中心</a></div>
       ...
       <%-- <ul class="layui-nav layui-layout-left">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <c:if test="${sessionScope.city_user == null}">
                <li class="layui-nav-item"><a href="${path}/backstage/cityPage/city_login.jsp">登录</a></li>
            </c:if>
            ...
            <c:if test="${sessionScope.city_user != null}">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="${path}/backstage/cityPage/city_updateCity.jsp">基本资料</a></dd>
                        <dd><a href="">安全设置</a></dd>
                    </dl>
                </li>
            ...
            <c:if test="${sessionScope.city_user != null}">
                <ul class="layui-nav layui-nav-tree layui-bg-cyan"  lay-filter="test">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="${pageContext.request.contextPath}/backstage/cityPage/vacc_request.jsp">疫苗入库</a></dd>
                        </dl>
                    </li>
    ...
    <div class="layui-body">
        ...
        <%--未登录状态--%>
        <c:if test="${sessionScope.city_user == null}">
            <div style="padding: 15px;">请先<a href="${path}/backstage/cityPage/city_login.jsp">登录</a></div>
        </c:if>

        <%--已登录状态--%>
        <c:if test="${sessionScope.city_user != null}">

            <iframe src="${path}/backstage/cityPage/lunbotu/lb1.jsp" id="main" name="content" height="100%" width="100%"></iframe>
        </c:if>
